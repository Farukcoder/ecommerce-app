<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav sidebar-accordion"
        ...
        <!-- Admin Menu -->
        <div class="sidebar-section">
            <div class="sidebar-section-title">{{ __('messages.administration') }}</div>
            ...
            <a href="{{ route($dashboardRoute::name('settings.system.index')) }}" class="sidebar-link {{ request()->routeIs($dashboardRoute::pattern('settings.system.*')) ? 'active' : '' }}">
                ...
                {{ __('messages.tyro_system_settings') }}
            </a>
            @endif
        ...
        <div class="sidebar-section">
            <div class="sidebar-section-title">{{ __('messages.settings') }}</div>
            ...
            <a href="{{ route('header-settings.index') }}" class="sidebar-link {{ request()->routeIs('header-settings.*') ? 'active' : '' }}">
                ...
                {{ __('messages.header_setting') }}
            </a>
            <a href="{{ route('shipping-costs.index') }}" class="sidebar-link {{ request()->routeIs('shipping-costs.*') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
